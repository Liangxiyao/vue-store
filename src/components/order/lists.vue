    ...
    <div class="mui-scroll">
        <ul class="order-list" v-if="lists.length">
            <li class="item goods-info-common" v-for="shop in lists" :key="shop.order_id">
                ...
                <div class="pro-item">						
                    <router-link tag="div" class="wbox item-wrap" :to="`/orderDetail/${item.order_id}`" v-for="(item,index) in shop.items" :key="index">
                    ...
                    <order-groups-btn :status="shop.order_status" :orderId="shop.order_id"></order-groups-btn>
